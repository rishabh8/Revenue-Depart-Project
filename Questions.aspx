                                ...
                                <asp:UpdatePanel ID="update2" ClientIDMode="Static" runat="server" UpdateMode="Always">
                                    <ContentTemplate>
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="quesno" runat="server" placeholder="प्रश्‍न संख्या" CssClass="form-control" OnTextChanged="quesno_TextChanged" AutoPostBack="true" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="revenueQuesno" runat="server" CssClass="form-control" Style="font-family: 'DevLys 010'; font-size: 20px;"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='datetimepicker1'>
                                        <asp:TextBox ID="listedDate" ClientIDMode="Static" runat="server" CssClass="form-control datepicker"></asp:TextBox>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='datetimepicker2'>
                                        <asp:TextBox ID="branchDate" runat="server" CssClass="form-control datepicker"></asp:TextBox>
                                        <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
