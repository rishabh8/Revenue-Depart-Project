<%@ Page Title="Answer of Questions" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Answer.aspx.cs" Inherits="Answer" ClientIDMode="Static" %>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> Answer Reporting <small>By User</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li >
                                <i class="fa fa-dashboard"></i> Enter Answer according to question
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <asp:Panel ID="messagebox" runat="server" CssClass="col-lg-12" >
                            <div class="alert alert-info alert-dismissable" >
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <i class="fa fa-info-circle"></i><strong>  Your Answer has been submit </strong>
                            </div>
                        </asp:Panel>
                        
                        <div class="col-lg-12" id="addControls" runat="server">
                        </div>
                        <div class="col-lg-12">
                            <div class="panel panel-yellow"></div> 
                            <div class="col-lg-3">
                                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">View Question File</asp:LinkButton>
                            </div>
                            <div class="col-lg-3">
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">View Answer File</asp:LinkButton>
                            </div>
                            <div class="col-lg-3">
                                <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">View FormatQuestion File</asp:LinkButton>
                            </div>
                            <div class="col-lg-3">
                                <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">View FormatAnswer File</asp:LinkButton>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <asp:Panel ID="Panel1" runat="server" CssClass="col-lg-4">
                                        <asp:FileUpload ID="FileUpload1" runat="server" AllowMultiple="True" ToolTip="Choose PDF File" CssClass="btn panel panel-info" />
                                    </asp:Panel>
                                    <asp:Panel ID="Panel3" runat="server" CssClass="col-lg-4" HorizontalAlign="Center">
                                        <asp:Label ID="lblMessage" runat="server" Text="Enter File Path" CssClass="alert alert-success" style="padding:4px" Height="33"></asp:Label>
                                    </asp:Panel>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <asp:Panel ID="Panel6" runat="server" CssClass="col-lg-4">
                                        <asp:Button ID="Button5" runat="server" Text="Upload" CssClass="btn btn-info btn-block" OnClick="uploads2_Click" />
                                    </asp:Panel><br />
                                    <br /> 
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-10">
                                    <asp:Button ID="Button2" runat="server" Text="Submit Answer" CssClass="btn btn-primary" OnClick="Button2_Click" />
                                    <asp:Button ID="Button3" runat="server" Text="Final Submit and Send" CssClass="btn btn-primary" OnClick="Button3_Click" />
                                    <asp:Button ID="Button4" runat="server" Text="Submit Answer" CssClass="btn btn-primary" OnClick="Button4_Click" Visible="false" />
                                </div>
                            </div>
                        </div>
                </div>
